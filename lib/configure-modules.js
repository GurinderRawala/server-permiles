...
const { createConfigureMiddleware, validationMiddleware, fileUploadMiddleware } = require('../api/middleware')
...
const { fileUploadService, getFileListService, getFileObjectService, deleteFileObjectService } = require('./file-upload-service');
...
exports.configureModules = async (config) => {
    ...
    const authenticationMiddleware = createConfigureMiddleware( { log, rbac, userAccountRepo, enabled: config.authentication.enabled, token, uuidRegex: config.uuidRegex })
