...
exports.configureModules = async (config) => {
    ...
    const authenticationMiddlware = createConfigureMiddlewares( { log, rbac, userAccountRepo, enabled: config.authentication.enabled, token, uuidRegex: config.uuidRegex })
