...
module.exports = {
  createAddLoad: ({ loadRepo, log, uploadService }) =>
    createLoad.bind(null, loadRepo, log, uploadService),
  createGetLoadList: ({ loadRepo, log }) =>
    getLoadList.bind(null, loadRepo, log),
  createUpdateLoad: ({ loadRepo, log }) => updateLoad.bind(null, loadRepo, log),
  createGetLoadById: ({ loadRepo, log }) =>
    getLoadById.bind(null, loadRepo, log),
  createGetLoadByLoadNumber: ({ loadRepo, log }) =>
    getLoadByLoadNumber.bind(null, loadRepo, log),
}
