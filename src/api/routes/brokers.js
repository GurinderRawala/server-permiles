...
exports.registerRoutes = (server, modules) => {
  ...
  const validateAddBroker =
    validation.brokerRoutesValidation('broker:add-broker')
  ...
  const validateUpdateBroker = validation.brokerRoutesValidation(
  ...
  router.post(
    ...
    [
      sessionHandler,
      determineUserRole,
      permissionsUpdateBroker,
      validateUpdateBroker,
    ],
    (req, res, next) => {
      if (validation.validationErrorMessage(req, res, next)) return
  ...
  const validateGetBrokersByName =
    validation.brokerRoutesValidation('broker:by-name')
  router.post(
    '/brokers/by-name',
    [
      sessionHandler,
      determineUserRole,
      permissionsGetBrokersList,
      validateGetBrokersByName,
    ],
    (req, res, next) => {
      if (validation.validationErrorMessage(req, res, next)) return
