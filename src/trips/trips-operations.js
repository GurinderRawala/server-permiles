...
async function updateTrip(tripRepo, log, trip, callback) {
  try {
    ...
    return res[0] === 1
      ? callback(null, { msg: `Load has been updated` })
...
module.exports = {
  createAddTrip: ({ tripRepo, log, uploadService }) =>
    createTrip.bind(null, tripRepo, log, uploadService),
  createGetTripList: ({ tripRepo, log }) =>
    getTripList.bind(null, tripRepo, log),
  createGetTripById: ({ tripRepo, log }) =>
    getTripById.bind(null, tripRepo, log),
  createGetTripByTripNumber: ({ tripRepo, log }) =>
    getTripByTripNumber.bind(null, tripRepo, log),
