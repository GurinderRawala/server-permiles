...
exports.registerRoutes = (server, modules)=>{
    ...
    router.post('/trucks/add-truck', 
        [uploadMiddleware, sessionHandler, determineUserRole, permissionsAddTruck, validateAddTruck],
        (req, res, next) => {
    ...
    router.post('/trucks/update-truck', 
        [sessionHandler, determineUserRole, permissionsUpdateTruck, validateUpdateTruck],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
    ...
    router.get('/trucks/:id', 
        [sessionHandler, determineUserRole, permissionsGetTruck, validateUpdateTruck],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
    ...
    const validateGetTruckByTruckNumber = truckRoutesValidation('truck:by-truck-number')
    router.post('/trucks/by-truck-number', 
        [sessionHandler, determineUserRole, permissionsGetTruck, validateGetTruckByTruckNumber],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
