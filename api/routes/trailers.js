...
exports.registerRoutes = (server, modules)=>{
    ...
    router.post('/trailers/add-trailer', 
        [uploadMiddleware, sessionHandler, determineUserRole, permissionsAddTrailer, validateAddTrailer],
        (req, res, next) => {
    ...
    const validateUpdateTrailer = trailerRoutesValidation('trailer:update-trailer')
    router.post('/trailers/update-trailer', 
        [sessionHandler, determineUserRole, permissionsUpdateTrailer, validateUpdateTrailer],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
    ...
    router.get('/trailers/:id', 
        [sessionHandler, determineUserRole, permissionsGetTrailer, validateUpdateTrailer],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
    ...
    router.post('/trailers/trailer-list', 
    ...
    const validateGetTrailerByTrailerNumber = trailerRoutesValidation('trailer:by-trailer-number')
    router.post('/trailers/by-trailer-number', 
        [sessionHandler, determineUserRole, permissionsGetTrailer, validateGetTrailerByTrailerNumber],
        (req, res, next) =>{
            if( validationErrorMessage(req, res, next) ) return
