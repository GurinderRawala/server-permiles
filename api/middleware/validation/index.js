...
const {
  trailerRoutesValidation,
} = require('./routes/trailer-routes-validation')
...
exports.validationMiddleware = ({
  ...
  clientRoutesValidation: clientRoutesValidation.bind(
    null,
    userAccountRepo,
    clientRepo,
    expressValidator
  ),
  userAccountValidation: userAccountValidation.bind(
    null,
    expressValidator,
    userAccountRepo
  ),
  driverRoutesValidation: driverRoutesValidation.bind(
    null,
    expressValidator,
    driverRepo,
    clientRepo
  ),
  brokerRoutesValidation: brokerRoutesValidation.bind(
    null,
    expressValidator,
    brokerRepo,
    clientRepo
  ),
  loadRoutesValidation: loadRoutesValidation.bind(
    null,
    expressValidator,
    loadRepo,
    clientRepo,
  ...
  tripRoutesValidation: tripRoutesValidation.bind(
    null,
    expressValidator,
    tripRepo,
    clientRepo,
  ...
  truckRoutesValidation: truckRoutesValidation.bind(
    null,
    expressValidator,
    truckRepo,
    clientRepo
  ),
  trailerRoutesValidation: trailerRoutesValidation.bind(
    null,
    expressValidator,
    trailerRepo,
    clientRepo
  ),
  fileRoutesValidation: fileRoutesValidation.bind(
    null,
    expressValidator,
    clientRepo
  ),
