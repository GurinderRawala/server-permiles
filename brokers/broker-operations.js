...
async function updateBroker (brokerRepo, log, broker, callback){
    try{
        ...
        if( res[0] === 1 ) { return callback(null, {msg: 'Broker has been updated'}) }
...
module.exports = {
    createAddBroker: ({ brokerRepo, log }) => addBroker.bind(null, brokerRepo, log),
    createUpdateBroker: ({brokerRepo, log}) => updateBroker.bind(null, brokerRepo, log),
    createGetBrokerList: ({brokerRepo, log}) => getBrokerList.bind(null, brokerRepo, log),
    createGetBrokerByName: ({brokerRepo, log}) => getBrokerByName.bind(null, brokerRepo, log)
}